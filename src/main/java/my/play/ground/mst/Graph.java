...
class Graph {
    ...
    public static String[][] readCsv() throws Exception {
        File myObj = new File("/Users/zli02/repo/Playground/src/main/resources/data.csv");
        ...
        while (myReader.hasNextLine()) {
            ...
            String strar[] = line.split(";");//get contents of line as an array
